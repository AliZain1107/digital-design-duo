      ...
      <LanguageProvider>
          <BrowserRouter>
            <TrailingSlashRedirect>
              ...
              <Route path="/en/pricing" element={<NotFound />} />
              <Route path="/fr/pricing" element={<NotFound />} />
              ...
              <Route path="/en/upload" element={<NotFound />} />
              <Route path="/fr/upload" element={<NotFound />} />
