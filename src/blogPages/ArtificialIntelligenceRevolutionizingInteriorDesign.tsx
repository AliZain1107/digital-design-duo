  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://www.styly.fr/${language === 'fr' ? 'fr/' : ''}blog/how-artificial-intelligence-is-revolutionizing-interior-design`} />
        ...
        <meta property="og:url" content={`https://www.styly.fr/${language === 'fr' ? 'fr/' : ''}blog/how-artificial-intelligence-is-revolutionizing-interior-design`} />
