    ...
    <>
      ...
      >
        <div className="w-full max-w-7xl mx-auto flex flex-col items-center text-center px-4">
          ...
          <div className="w-full max-w-[1200px] mx-auto mb-7 sm:mb-8 md:mb-10">
            <h1 className="sr-only">STYLY - #1 most used AI design tool for modern spaces</h1>
            
            <div className="flex flex-col items-center justify-center font-extrabold tracking-tight leading-[0.9]">
          ...
          <div className="w-full max-w-4xl text-center text-[rgba(44,30,73,1)] mb-7 sm:mb-8 md:mb-10" itemProp="description">
            <p className="text-base xs:text-lg sm:text-xl md:text-2xl lg:text-3xl font-light leading-tight">
              {t.redesignEmptyRooms}
              <br className="hidden sm:block" />
              {t.forRealEstate}
              <span className="font-extrabold italic"> {t.noToolsNoDownloads}</span>.
            </p>
          </div>
          ...
          {/* Supporting text */}
          <p className="text-gray-900 font-semibold text-xs xs:text-sm md:text-lg lg:text-xl tracking-wide">
