...
const Hero: React.FC = () => {
  ...
  return (
    <>
      ...
      <section
        className="flex w-full flex-col items-center justify-center min-h-[calc(100vh-70px)] px-4 sm:px-6 lg:px-8 py-4 sm:py-6 bg-white"
        aria-label="Hero section"
        itemScope
        itemType="https://schema.org/WebPageElement"
      >
        <div className="w-full max-w-6xl mx-auto flex flex-col items-center text-center h-full justify-center space-y-3 sm:space-y-4 md:space-y-5">
          ...
          <div className="flex justify-center transform hover:scale-[1.05] transition-all duration-700">
            <img
              ...
              className="h-16 sm:h-20 md:h-24 w-auto drop-shadow-2xl opacity-90 hover:opacity-100 transition-opacity duration-500"
              width="180"
              height="128"
              loading="eager"
              decoding="async"
          ...
          <a
            ...
            className="group relative inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 text-sm sm:text-base md:text-lg font-semibold text-white transition-all duration-500 ease-out rounded-xl shadow-2xl hover:shadow-orange-500/25 transform hover:scale-[1.02] hover:-translate-y-1"
            style={{
          ...
          >
            ...
            <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-orange-600 to-orange-700 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
          </a>
