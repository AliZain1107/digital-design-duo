...
const Hero: React.FC = () => {
  ...
  const heroStructuredData = {
    ...
    name: "STYLY AI Interior Design Platform",
    description:
      "AI-powered platform that transforms empty spaces into beautifully furnished, realistic visuals with just a photo upload or description.",
    image: "/hero-room-transformation.png",
    brand: {
      "@type": "Brand",
      name: "STYLY"
      ...
      >
        <div className="absolute inset-0 overflow-hidden" style={{ opacity: 0.13 }}>
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent 0%, rgba(147, 51, 234, 0.2) 20%, rgba(249, 115, 22, 0.3) 50%, rgba(147, 51, 234, 0.2) 80%, transparent 100%)",
              width: "200%",
              height: "100%",
              filter: "blur(1px)"
            }}
        ...
        <div className="w-full max-w-6xl mx-auto flex flex-col items-center text-center h-full justify-center space-y-4 sm:space-y-5 md:space-y-6 relative z-10">
          <div className="w-full max-w-5xl mx-auto">
            <h1 className="text-4xl xs:text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-gray-900 mb-8 animate-fade-in whitespace-pre-line font-baloo">
              Design,{" "}
            ...
            <div className="flex flex-col items-center justify-center">
              <h2 className="text-lg xs:text-xl sm:text-2xl md:text-3xl lg:text-4xl font-semibold tracking-wide leading-tight text-purple-700 animate-fade-in font-baloo">
                {displayed}
                <span
                  className="inline-block w-2 bg-orange-500 animate-pulse ml-1"
                  style={{ height: "0.9em", transform: "translateY(0.1em)" }}
                ></span>
              </h2>
            </div>
          </div>
          ...
          <div className="w-full max-w-3xl mx-auto" itemProp="description">
            <p className="text-base sm:text-lg md:text-xl font-bold leading-snug text-gray-600 tracking-wide animate-fade-in font-baloo">
              Upload a photo and see your empty space become a beautifully furnished, realistic room. No tools. No downloads. Just{" "}
              <span className="font-davetica-wide bg-gradient-to-r from-[#593286] via-purple-400 to-[#FA6F40] bg-[length:200%_200%] bg-clip-text text-transparent animate-gradient-x">
                STYLY
              </span>
              .
            </p>
          ...
          <div
            className="flex flex-row flex-wrap items-center justify-center gap-4 sm:gap-6 mt-10 animate-fade-in"
          ...
          >
            ...
            >
              <span className="transition-all duration-300 group-hover:drop-shadow-[0_0_12px_white]">
                Start Free Trial
              </span>
            </button>
