...
const ArchitectureRevolution: React.FC = () => {
  return (
    <>
      <img
        src="https://cdn.builder.io/api/v1/image/assets/a22916bd9acc4a4986d78d713f5de3db/1c251803028f1c2bf1a9b3163604a2c560dd18dd?placeholderIfAbsent=true"
        alt="Design showcase"
        className="aspect-[2.75] object-contain w-full mt-[133px] max-md:max-w-full max-md:mt-10"
      />
      <section className="bg-white flex w-full flex-col items-center mt-[1268px] px-5 max-md:max-w-full max-md:mt-10">
