          ...
          <div className="flex flex-col items-center text-center group relative max-w-4xl mx-auto">
            ...
            <p className="text-base sm:text-lg md:text-xl font-baloo font-normal leading-snug text-gray-600 tracking-wide max-w-xs mx-auto mb-6">
              {language === 'fr'
                ...
                : <>Enjoy a realistic result generated by <span className="font-davetica-wide bg-gradient-to-r from-[#593286] via-purple-400 to-[#FA6F40] bg-[length:200%_200%] bg-clip-text text-transparent animate-gradient-x">STYLY</span> in seconds.</>}
            </p>
            {/* Before/After Slider */}
