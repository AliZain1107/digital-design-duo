  ...
  return (
    <section className="bg-white w-full flex flex-col items-center justify-center py-16 sm:py-20 px-4 sm:px-6 md:px-10" key={`how-it-works-${language}`}>
      <div className="w-full max-w-6xl mx-auto">
        {/* Section header */}
        <h2 className="text-xl sm:text-2xl md:text-3xl font-baloo font-extrabold tracking-tight leading-tight text-gray-900 mb-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 mb-16 relative">
          ...
          <div className="flex flex-col items-center text-center group relative">
            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-pink-50 to-purple-50 flex items-center justify-center mb-6 shadow-md transition-all duration-300 group-hover:shadow-lg overflow-hidden border border-purple-100 relative z-10">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-14 h-14 text-purple-700 group-hover:scale-110 transition-transform duration-300">
